...
options.maxIter = minFuncMaxIter; % Maximum number of iterations of L-BFGS to run 
options.display = 'on';
...
saeSoftmaxModel = softmaxTrain(hiddenSizeL2, numClasses, lambda, ...
...
stackedAEOptTheta = [ saeSoftmaxOptTheta ; stackparams ];
